 ...
 */
public protocol BlobProtocol: AnyObject, Sendable {
    
    /**
     * A [`Commitment`] computed from the [`Blob`]s data.
     */
    func commitment()  -> RustCommitment
 ...
 * Arbitrary data that can be stored in the network within certain [`Namespace`].
 */
open class Blob: BlobProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_celestia_types_fn_clone_blob(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_celestia_types_fn_free_blob(pointer, $0) }
    }
     ...
     */
public static func create(namespace: Namespace, data: Data, appVersion: AppVersion)throws  -> Blob  {
    return try  FfiConverterTypeBlob_lift(try rustCallWithError(FfiConverterTypeUniffiError_lift) {
    uniffi_celestia_types_fn_constructor_blob_create(
        FfiConverterTypeNamespace_lower(namespace),
     ...
     */
public static func createWithSigner(namespace: Namespace, data: Data, signer: AccAddress, appVersion: AppVersion)throws  -> Blob  {
    return try  FfiConverterTypeBlob_lift(try rustCallWithError(FfiConverterTypeUniffiError_lift) {
    uniffi_celestia_types_fn_constructor_blob_create_with_signer(
        FfiConverterTypeNamespace_lower(namespace),
        FfiConverterData.lower(data),
        FfiConverterTypeAccAddress_lower(signer),
        FfiConverterTypeAppVersion_lower(appVersion),$0
    )
})
}
     ...
     * A [`Commitment`] computed from the [`Blob`]s data.
     */
open func commitment() -> RustCommitment  {
    return try!  FfiConverterTypeRustCommitment_lift(try! rustCall() {
    uniffi_celestia_types_fn_method_blob_commitment(self.uniffiClonePointer(),$0
    )
})
}
...
open func data() -> Data  {
    ...
    uniffi_celestia_types_fn_method_blob_data(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * Index of the blob's first share in the EDS. Only set for blobs retrieved from chain.
     */
open func index() -> UInt64?  {
    return try!  FfiConverterOptionUInt64.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_blob_index(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * A [`Namespace`] the [`Blob`] belongs to.
     */
open func namespace() -> Namespace  {
    return try!  FfiConverterTypeNamespace_lift(try! rustCall() {
    uniffi_celestia_types_fn_method_blob_namespace(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * Version indicating the format in which [`Share`]s should be created from this [`Blob`].
     */
open func shareVersion() -> UInt8  {
    return try!  FfiConverterUInt8.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_blob_share_version(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * Must be present in `share_version 1` and absent otherwise.
     */
open func signer() -> AccAddress?  {
    return try!  FfiConverterOptionTypeAccAddress.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_blob_signer(self.uniffiClonePointer(),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeBlob: FfiConverter {

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = Blob

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> Blob {
        return Blob(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: Blob) -> UnsafeMutableRawPointer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlob_lift(_ pointer: UnsafeMutableRawPointer) throws -> Blob {
    return try FfiConverterTypeBlob.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlob_lower(_ value: Blob) -> UnsafeMutableRawPointer {
 ...
 * user-submitted data.
 */
public protocol NamespaceProtocol: AnyObject, Sendable {
 ...
 * user-submitted data.
 */
open class Namespace: NamespaceProtocol, @unchecked Sendable {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_celestia_types_fn_clone_namespace(self.pointer, $0) }
    }
    /**
     ...
     */
public convenience init(version: UInt8, id: Data)throws  {
    let pointer =
        try rustCallWithError(FfiConverterTypeUniffiError_lift) {
    uniffi_celestia_types_fn_constructor_namespace_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_celestia_types_fn_free_namespace(pointer, $0) }
    }
     ...
     */
public static func newV0(id: Data)throws  -> Namespace  {
    return try  FfiConverterTypeNamespace_lift(try rustCallWithError(FfiConverterTypeUniffiError_lift) {
    uniffi_celestia_types_fn_constructor_namespace_new_v0(
        FfiConverterData.lower(id),$0
    )
})
}
...
open func bytes() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_namespace_bytes(self.uniffiClonePointer(),$0
    )
})
}
...
open func id() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_namespace_id(self.uniffiClonePointer(),$0
    )
})
}
...
open func idV0() -> Data?  {
    ...
    uniffi_celestia_types_fn_method_namespace_id_v0(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * Returns true if the namespace is reserved for special purposes.
     */
open func isReserved() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_namespace_is_reserved(self.uniffiClonePointer(),$0
    )
})
}
...
open func version() -> UInt8  {
    return try!  FfiConverterUInt8.lift(try! rustCall() {
    uniffi_celestia_types_fn_method_namespace_version(self.uniffiClonePointer(),$0
    )
})
}
...
public struct FfiConverterTypeNamespace: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> Namespace {
        return Namespace(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: Namespace) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeNamespace_lift(_ pointer: UnsafeMutableRawPointer) throws -> Namespace {
    return try FfiConverterTypeNamespace.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeNamespace_lower(_ value: Namespace) -> UnsafeMutableRawPointer {
...
public struct BaseAccount {
     ...
     */
    public var address: RustAddress
    /**
...
public struct FfiConverterTypeBaseAccount: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BaseAccount {
        return
            try BaseAccount(
                address: FfiConverterTypeRustAddress.read(from: &buf), 
    ...
    public static func write(_ value: BaseAccount, into buf: inout [UInt8]) {
        FfiConverterTypeRustAddress.write(value.address, into: &buf)
...
public struct FfiConverterTypeBlock: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Block {
        return
            try Block(
                ...
                data: FfiConverterTypeBlockData.read(from: &buf), 
    ...
    public static func write(_ value: Block, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeBlockData.write(value.data, into: &buf)
...
#if compiler(>=6)
extension BlockData: Sendable {}
#endif


extension BlockData: Equatable, Hashable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeBlockData: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BlockData {
        return
            try BlockData(
    ...
    public static func write(_ value: BlockData, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlockData_lift(_ buf: RustBuffer) throws -> BlockData {
    return try FfiConverterTypeBlockData.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlockData_lower(_ value: BlockData) -> RustBuffer {
    return FfiConverterTypeBlockData.lower(value)
}
...
public struct Fee {
     ...
     */
    public var payer: RustAddress?
    /**
     * if set, the fee payer (either the first signer or the value of the payer field) requests that a fee grant be used
     * to pay fees instead of the fee payer's own balance. If an appropriate fee grant does not exist or the chain does
     * not support fee grants, this will fail
     */
    public var granter: RustAddress?
...
public struct FfiConverterTypeFee: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Fee {
        return
            try Fee(
                ...
                payer: FfiConverterOptionTypeRustAddress.read(from: &buf), 
                granter: FfiConverterOptionTypeRustAddress.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: Fee, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeRustAddress.write(value.payer, into: &buf)
        FfiConverterOptionTypeRustAddress.write(value.granter, into: &buf)
    }
}
...
public struct Header {
    ...
    public init(
        ...
        /**
         * Commit from validators from the last block
         */lastCommitHash: TendermintHash?, 
        /**
         * Merkle root of transaction hashes
         */dataHash: TendermintHash?, 
        /**
         * Validators for the current block
         */validatorsHash: TendermintHash, 
        /**
         * Validators for the next block
         */nextValidatorsHash: TendermintHash, 
        /**
         * Consensus params for the current block
         */consensusHash: TendermintHash, 
        /**
         * State after txs from the previous block
         */appHash: AppHash, 
        /**
         * Root hash of all results from the txs from the previous block
         */lastResultsHash: TendermintHash?, 
        /**
         * Hash of evidence included in the block
         */evidenceHash: TendermintHash?, 
        /**
         * Original proposer of the block
...
public enum Address {
     ...
     * Validator address.
     */
    case validator(AccountId
    )
    /**
     * Consensus address.
     */
    case consensus(AccountId
    )
}
...
public struct FfiConverterTypeAddress: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Address {
        ...
        case 1: return .account(try FfiConverterTypeAccountId.read(from: &buf)
        )
        
        case 2: return .validator(try FfiConverterTypeAccountId.read(from: &buf)
        )
        
        case 3: return .consensus(try FfiConverterTypeAccountId.read(from: &buf)
        )
    ...
    public static func write(_ value: Address, into buf: inout [UInt8]) {
        ...
        case let .account(v1):
            ...
            FfiConverterTypeAccountId.write(v1, into: &buf)
...
public enum Evidence {
    ...
    case lightClientAttack(
         ...
         */byzantineValidators: [ValidatorInfo], 
        /**
         * Total voting power
         */totalVotingPower: UInt64, 
        /**
 ...
 */
public enum UniffiConversionError: Swift.Error {
     ...
     */
    case CouldNotGenerateCommitment(
        /**
         * error message
         */msg: String
    )
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeUniffiConversionError: FfiConverterRustBuffer {
    typealias SwiftType = UniffiConversionError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> UniffiConversionError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: UniffiConversionError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeUniffiConversionError_lift(_ buf: RustBuffer) throws -> UniffiConversionError {
    return try FfiConverterTypeUniffiConversionError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeUniffiConversionError_lower(_ value: UniffiConversionError) -> RustBuffer {
    return FfiConverterTypeUniffiConversionError.lower(value)
}


extension UniffiConversionError: Equatable, Hashable {}




extension UniffiConversionError: Foundation.LocalizedError {
    public var errorDescription: String? {
...
public enum UniffiError: Swift.Error {
     ...
     */
    case UnsupportedNamespaceVersion(UInt8
    )
    /**
     * Unsupported app version.
     */
    case UnsupportedAppVersion(UInt64
    )
    /**
     * Invalid namespace size.
     */
    case InvalidNamespaceSize
    /**
     * Error propagated from the [`tendermint`].
     */
    case Tendermint(String
    )
    /**
     ...
     */
    case MissingValidatorSet
    /**
     * Missing data availability header.
     */
    case MissingDataAvailabilityHeader
    /**
     * Missing proof.
     */
    case MissingProof
     ...
     */
    case MissingModeInfo
    /**
     * Missing bitarray field
     */
    case MissingBitarray
    /**
     * Bit array too large
     */
    case BitarrayTooLarge
    /**
     * Malformed CompactBitArray
     */
    case MalformedCompactBitArray
    /**
     * Wrong proof type.
     */
    case WrongProofType
     ...
     * Unsupported share version.
     */
    case UnsupportedShareVersion(UInt8
    )
    /**
     * Invalid share size.
     */
    case InvalidShareSize(UInt64
    )
    /**
     * Invalid nmt leaf size.
     */
    case InvalidNmtLeafSize(UInt64
    )
    /**
     * Invalid nmt node order.
     */
    case InvalidNmtNodeOrder
    /**
     * Share sequence length exceeded.
     */
    case ShareSequenceLenExceeded(UInt64
    )
    /**
     * Invalid namespace in version 0.
     */
    case InvalidNamespaceV0
    /**
     * Invalid namespace in version 255.
     */
    case InvalidNamespaceV255
    /**
     * Invalid namespaced hash.
     */
    case InvalidNamespacedHash(String
    )
    /**
     * Invalid index of signature in commit.
     */
    case InvalidSignatureIndex(UInt64,UInt64
    )
    /**
     * Invalid axis.
     */
    case InvalidAxis(Int32
    )
    /**
     * Invalid Shwap proof type in Protobuf.
     */
    case InvalidShwapProofType(Int32
    )
    /**
     ...
     */
    case UnexpectedAbsentSignature
    /**
     ...
     */
    case MaxShareVersionExceeded(UInt8
    )
    /**
     ...
     */
    case InvalidAddressPrefix(String
    )
    /**
     * Invalid size of the address.
     */
    case InvalidAddressSize(UInt64
    )
    /**
     * Invalid address.
     */
     ...
     */
    case InvalidBalanceDenomination(String
    )
    /**
     ...
     * Invalid coin amount.
     */
    case InvalidCoinAmount(String
    )
    /**
     * Invalid Public Key
     */
    case InvalidPublicKeyType(String
    )
    /**
     * Unsupported fraud proof type.
     */
    case UnsupportedFraudProofType(String
    )
    /**
     * Data square index out of range.
     */
    case IndexOutOfRange(UInt64,UInt64
    )
    /**
     * Data square index out of range.
     */
    case EdsIndexOutOfRange(UInt16,UInt16
    )
    /**
     * Could not create EDS, provided number of shares doesn't form a pefect square.
     */
    case EdsInvalidDimentions
    /**
     * Zero block height.
     */
    case ZeroBlockHeight
    /**
     * Expected first share of a blob
     */
    case ExpectedShareWithSequenceStart
    /**
     * Unexpected share from reserved namespace.
     */
    case UnexpectedReservedNamespace
    /**
     * Unexpected start of a new blob
     */
    case UnexpectedSequenceStart
    /**
     * Metadata mismatch between shares in blob.
     */
    case BlobSharesMetadataMismatch(String
    )
    /**
...
public struct FfiConverterTypeUniffiError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> UniffiError {
        ...
        case 1: return .UnsupportedNamespaceVersion(
            try FfiConverterUInt8.read(from: &buf)
            )
        case 2: return .UnsupportedAppVersion(
            try FfiConverterUInt64.read(from: &buf)
            )
        case 3: return .InvalidNamespaceSize
        case 4: return .Tendermint(
            try FfiConverterString.read(from: &buf)
            )
        case 5: return .Protobuf(
            try FfiConverterString.read(from: &buf)
            )
        case 6: return .Multihash(
            try FfiConverterString.read(from: &buf)
            )
        case 7: return .CidError(
            try FfiConverterString.read(from: &buf)
            )
        case 8: return .LeopardCodec(
            try FfiConverterString.read(from: &buf)
            )
        case 9: return .MissingHeader
        case 10: return .MissingCommit
        case 11: return .MissingValidatorSet
        case 12: return .MissingDataAvailabilityHeader
        case 13: return .MissingProof
        case 14: return .MissingShares
        case 15: return .MissingFee
        case 16: return .MissingSum
        case 17: return .MissingModeInfo
        case 18: return .MissingBitarray
        case 19: return .BitarrayTooLarge
        case 20: return .MalformedCompactBitArray
        case 21: return .WrongProofType
        case 22: return .UnsupportedShareVersion(
            try FfiConverterUInt8.read(from: &buf)
            )
        case 23: return .InvalidShareSize(
            try FfiConverterUInt64.read(from: &buf)
            )
        case 24: return .InvalidNmtLeafSize(
            try FfiConverterUInt64.read(from: &buf)
            )
        case 25: return .InvalidNmtNodeOrder
        case 26: return .ShareSequenceLenExceeded(
            try FfiConverterUInt64.read(from: &buf)
            )
        case 27: return .InvalidNamespaceV0
        case 28: return .InvalidNamespaceV255
        case 29: return .InvalidNamespacedHash(
            try FfiConverterString.read(from: &buf)
            )
        case 30: return .InvalidSignatureIndex(
            try FfiConverterUInt64.read(from: &buf), 
            try FfiConverterUInt64.read(from: &buf)
            )
        case 31: return .InvalidAxis(
            try FfiConverterInt32.read(from: &buf)
            )
        case 32: return .InvalidShwapProofType(
            try FfiConverterInt32.read(from: &buf)
            )
        case 33: return .InvalidPublicKey
        case 34: return .RangeProofError(
            try FfiConverterString.read(from: &buf)
            )
        case 35: return .RootMismatch
        case 36: return .UnexpectedAbsentSignature
        case 37: return .Validation(
            try FfiConverterString.read(from: &buf)
            )
        case 38: return .Verification(
            try FfiConverterString.read(from: &buf)
            )
        case 39: return .MaxShareVersionExceeded(
            try FfiConverterUInt8.read(from: &buf)
            )
        case 40: return .Nmt(
            try FfiConverterString.read(from: &buf)
            )
        case 41: return .InvalidAddressPrefix(
            try FfiConverterString.read(from: &buf)
            )
        case 42: return .InvalidAddressSize(
            try FfiConverterUInt64.read(from: &buf)
            )
        case 43: return .InvalidAddress(
            try FfiConverterString.read(from: &buf)
            )
        case 44: return .InvalidBalanceDenomination(
            try FfiConverterString.read(from: &buf)
            )
        case 45: return .InvalidBalanceAmount(
            try FfiConverterString.read(from: &buf)
            )
        case 46: return .InvalidCoinAmount(
            try FfiConverterString.read(from: &buf)
            )
        case 47: return .InvalidPublicKeyType(
            try FfiConverterString.read(from: &buf)
            )
        case 48: return .UnsupportedFraudProofType(
            try FfiConverterString.read(from: &buf)
            )
        case 49: return .IndexOutOfRange(
            try FfiConverterUInt64.read(from: &buf), 
            try FfiConverterUInt64.read(from: &buf)
            )
        case 50: return .EdsIndexOutOfRange(
            try FfiConverterUInt16.read(from: &buf), 
            try FfiConverterUInt16.read(from: &buf)
            )
        case 51: return .EdsInvalidDimentions
        case 52: return .ZeroBlockHeight
        case 53: return .ExpectedShareWithSequenceStart
        case 54: return .UnexpectedReservedNamespace
        case 55: return .UnexpectedSequenceStart
        case 56: return .BlobSharesMetadataMismatch(
            try FfiConverterString.read(from: &buf)
            )
        case 57: return .BlobTooLarge
        case 58: return .InvalidComittmentLength
        case 59: return .MissingSigner
        case 60: return .SignerNotSupported
        case 61: return .EmptyBlobList
    ...
    public static func write(_ value: UniffiError, into buf: inout [UInt8]) {
        ...
        case let .UnsupportedNamespaceVersion(v1):
            writeInt(&buf, Int32(1))
            FfiConverterUInt8.write(v1, into: &buf)
            
        
        case let .UnsupportedAppVersion(v1):
            writeInt(&buf, Int32(2))
        ...
        case let .Tendermint(v1):
            writeInt(&buf, Int32(4))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .Protobuf(v1):
            writeInt(&buf, Int32(5))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .Multihash(v1):
            writeInt(&buf, Int32(6))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .CidError(v1):
            writeInt(&buf, Int32(7))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .LeopardCodec(v1):
            writeInt(&buf, Int32(8))
            FfiConverterString.write(v1, into: &buf)
        ...
        case let .UnsupportedShareVersion(v1):
            writeInt(&buf, Int32(22))
            FfiConverterUInt8.write(v1, into: &buf)
            
        
        case let .InvalidShareSize(v1):
            writeInt(&buf, Int32(23))
            FfiConverterUInt64.write(v1, into: &buf)
            
        
        case let .InvalidNmtLeafSize(v1):
            writeInt(&buf, Int32(24))
            FfiConverterUInt64.write(v1, into: &buf)
        ...
        case let .ShareSequenceLenExceeded(v1):
            writeInt(&buf, Int32(26))
            FfiConverterUInt64.write(v1, into: &buf)
        ...
        case let .InvalidNamespacedHash(v1):
            writeInt(&buf, Int32(29))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .InvalidSignatureIndex(v1,v2):
            writeInt(&buf, Int32(30))
            FfiConverterUInt64.write(v1, into: &buf)
            FfiConverterUInt64.write(v2, into: &buf)
            
        
        case let .InvalidAxis(v1):
            writeInt(&buf, Int32(31))
            FfiConverterInt32.write(v1, into: &buf)
            
        
        case let .InvalidShwapProofType(v1):
            writeInt(&buf, Int32(32))
            FfiConverterInt32.write(v1, into: &buf)
        ...
        case let .MaxShareVersionExceeded(v1):
            writeInt(&buf, Int32(39))
            FfiConverterUInt8.write(v1, into: &buf)
        ...
        case let .InvalidAddressPrefix(v1):
            writeInt(&buf, Int32(41))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .InvalidAddressSize(v1):
            writeInt(&buf, Int32(42))
            FfiConverterUInt64.write(v1, into: &buf)
        ...
        case let .InvalidBalanceDenomination(v1):
            writeInt(&buf, Int32(44))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .InvalidBalanceAmount(v1):
            writeInt(&buf, Int32(45))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .InvalidCoinAmount(v1):
            writeInt(&buf, Int32(46))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .InvalidPublicKeyType(v1):
            writeInt(&buf, Int32(47))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .UnsupportedFraudProofType(v1):
            writeInt(&buf, Int32(48))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .IndexOutOfRange(v1,v2):
            writeInt(&buf, Int32(49))
            FfiConverterUInt64.write(v1, into: &buf)
            FfiConverterUInt64.write(v2, into: &buf)
            
        
        case let .EdsIndexOutOfRange(v1,v2):
            writeInt(&buf, Int32(50))
            FfiConverterUInt16.write(v1, into: &buf)
            FfiConverterUInt16.write(v2, into: &buf)
        ...
        case let .BlobSharesMetadataMismatch(v1):
            writeInt(&buf, Int32(56))
            FfiConverterString.write(v1, into: &buf)
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeRustAddress: FfiConverterRustBuffer {
    typealias SwiftType = RustAddress?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeRustAddress.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeRustAddress.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias RustAddress = Address

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRustAddress: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RustAddress {
        return try FfiConverterTypeAddress.read(from: &buf)
    }

    public static func write(_ value: RustAddress, into buf: inout [UInt8]) {
        return FfiConverterTypeAddress.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> RustAddress {
        return try FfiConverterTypeAddress_lift(value)
    }

    public static func lower(_ value: RustAddress) -> RustBuffer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRustAddress_lift(_ value: RustBuffer) throws -> RustAddress {
    return try FfiConverterTypeRustAddress.lift(value)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRustAddress_lower(_ value: RustAddress) -> RustBuffer {
    return FfiConverterTypeRustAddress.lower(value)
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_celestia_types_checksum_method_blob_commitment() != 14787) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_blob_data() != 57764) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_blob_index() != 19248) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_blob_namespace() != 35334) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_blob_share_version() != 55295) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_blob_signer() != 23978) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_namespace_bytes() != 30880) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_namespace_id() != 54384) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_namespace_id_v0() != 5470) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_namespace_is_reserved() != 43756) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_method_namespace_version() != 20163) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_constructor_blob_create() != 58477) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_constructor_blob_create_with_signer() != 20201) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_constructor_namespace_new() != 62115) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_celestia_types_checksum_constructor_namespace_new_v0() != 5381) {
        return InitializationResult.apiChecksumMismatch
    }
